    ...
    return (<div>
        ...
        <div style={{ margin: 20, padding: 20, marginLeft: '10%', width: '81%', letterSpacing: 0.3, color: '#47424c', fontSize: matches ? 16.6 : 16 }}>
            ...
            <div style={{ marginTop: 10 }}>
                <p style={{ marginBottom: matches ? 7 : 10 }}>Varsha Research Organisation is a peer-reviewed international open-access online scholarly journal publishing innovative and creative technological research, located at 39, Kishanbhag, Bahodapur, Gwalior MP-474012.</p>
                The journal was started in 2025 with an aim to provide an easy, open and affordable platform for the whole global community of researchers, engineers, students, developers etc.
